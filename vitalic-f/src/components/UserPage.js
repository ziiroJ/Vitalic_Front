  ...
  return (
    <Container>
      ...
      <Section mHeight="100px;">
        ...
        <SectionSub>
          <b>Monthly Budget:</b> {userData.userBudgetMonth.toLocaleString()}원
        </SectionSub>
        <SectionSub>
          <b>Weekly Budget:</b> {userData.userBudgetWeek.toLocaleString()}원
        </SectionSub>
        <SectionSub>
          <b>Daily Budget:</b> {userData.userBudgetDay.toLocaleString()}원
        </SectionSub>
      </Section>
